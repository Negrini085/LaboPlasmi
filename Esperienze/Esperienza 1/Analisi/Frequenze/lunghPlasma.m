...
path_out = '/home/filippo/Desktop/CODICINI/LABO_PLASMI/Esperienze/Esperienza 1/Analisi/Frequenze/LunghezzaPlasma/Lp_serie9.txt';
...
for k=sign
    ...
    nth = floor(0.785 * nr); l_pixel = rw/nr; bc = zeros(nth, 1); 
    ...
    for i=1:N_it
        disp(['Calcolo lunghezza di plasma --> Immagine: ' num2str(k) ' Iterazione: ' num2str(i)])
