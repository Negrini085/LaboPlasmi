...
%           ---> valore del raggio
function opticalOffset(path, sign, nome_serie)
    % File per contenere i dati elaborati
    new_data = fopen(['/home/filippo/Desktop/CODICINI/LABO_PLASMI/Esperienze/Esperienza 1/Analisi/Offset/Ottici/' nome_serie],'w');
...
opticalOffset(path, sign, fileout);